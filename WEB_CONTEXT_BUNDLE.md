...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-0f19c5af664296b9"
    ],
    "allowed_axioms": [
    ...
    "domain": {
      "description": "Draft source observation in Number theory, Arithmetic geometry; domain extraction is unresolved.",
      "objects": [
    ...
    "problem_id": "problem:wikipedia-0f19c5af664296b9",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-0f19c5af664296b9",
        "url": "https://en.wikipedia.org/wiki/Sato%E2%80%93Tate_conjecture"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Sato–Tate conjecture : also a number of related conjectures that are generalizations of the original conjecture.",
      "version": 1
    },
    "title": "Sato–Tate conjecture",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "86b8a08f520ee66ccd7fa6e0ed3bccd15d2f19f901e34f064463661d9d5823fa"
}
```
